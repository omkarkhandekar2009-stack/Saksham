    ...
    <div className="space-y-8 py-2">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-[#0f2b5c] border border-cyan-500/30 p-6 rounded-3xl shadow-xl">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={() => setAuditMsg(language === 'hi' ? '✅ सक्रिय सत्र हेतु अनुपालन ऑडिट चेकलिस्ट प्रारंभ की गई!' : language === 'mr' ? '✅ सक्रिय सत्रासाठी अनुपालन ऑडिट चेकलिस्ट सुरू केली!' : '✅ Verification audit checklist initiated for active semester!')}
      ...
      {auditMsg && (
        <div className="p-4 bg-emerald-950/80 border border-emerald-400/40 rounded-2xl text-xs text-emerald-200 flex items-center justify-between gap-2 animate-in fade-in-50">
          ...
          <button onClick={() => setAuditMsg(null)} className="text-blue-300 hover:text-white p-1">
            ✕
          </button>
        </div>
      )}
